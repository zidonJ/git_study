...
// 格子索引
kernel void
grayKernel(texture2d<float, access::read>  sourceTexture  [[textureLYKernelTextureIndexSource]], device LYColorBuffer &out [[buffer(LYKernelBufferIndexOutput)]], uint2 grid [[thread_position_in_grid]])
{
    // 边界保护
