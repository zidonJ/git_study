...
- (void)presentationTransitionWillBegin
{
    ...
    {
        UIView *presentationWrapperView = [[UIView alloc] initWithFrame:CGRectMake(667-420, 0, 420, 375)];
...
//    self.presentationWrappingView.frame = self.frameOfPresentedViewInContainerView;
    self.presentationWrappingView.frame = CGRectMake(667-420, 0, 420, 375);
}
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    toViewFinalFrame.size = toViewController.preferredContentSize;
    //toViewFinalFrame.origin = CGPointMake(containerView.bounds.size.width - toViewFinalFrame.size.width, 0);
